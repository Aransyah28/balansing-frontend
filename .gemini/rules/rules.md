# AI Rules for Flutter (Balansing-FrontEnd)

> **MANDATORY READING:** Sebelum memberikan solusi teknis, Anda **DIWAJIBKAN** untuk membaca `AGENTS.md` dan `SSoT.md` di root direktori repositori ini untuk pedoman arsitektur yang spesifik dengan Balansing (State Management, Routing, Naming Conventions). Aturan di `AGENTS.md` **menggantikan** (override) aturan default jika ada konflik.

class DashboardData {
    ...
    factory DashboardData.fromJson(Map<String, dynamic> json) {
        return DashboardData(
            ...
            bb: json['bb']?.toDouble() ?? 0.0,
            tb: json['tb']?.toDouble() ?? 0.0,
            bbl: json['bbL']?.toDouble() ?? 0.0,
            tbl: json['tbL']?.toDouble() ?? 0.0,
            umur: json['umur'],
            rekomendasi: json['rekomendasi'],
            statusStunting: json['statusStunting'],
            statusAnemia: json['statusAnemia'] ?? false,
            zScore: json['zScore']?.toDouble() ?? 0.0,

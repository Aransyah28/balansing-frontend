...
class GrowthChartCard extends StatelessWidget {
  ...
  Widget _getGrowthComparison(double width, String TextJenis) {
    ...
    final color =
        selisih >= 0 ? const Color(0xFF76A73B) : const Color(0xFFDC2626);
  ...
  Widget _getGrowthComparison2(
      double width, String TextJenis, double beratLahir) {
    //final lastValue = data.last.value;
    //final secondLastValue = data[data.length - 2].value;
    //final growth = lastValue - secondLastValue;
                  ...
                  child: LineChart(
                    LineChartData(
                      ...
                      titlesData: FlTitlesData(
                        bottomTitles: AxisTitles(
                          sideTitles: SideTitles(
                            showTitles: true,
                            interval:
                                1, // Mengatur interval agar label tidak tumpang tindih
                      ...
                      lineBarsData: [
                        LineChartBarData(
                          spots: data
                              .map((d) => FlSpot(d.month.toDouble(), d.value))
                              .toList(),
                          isCurved: true,

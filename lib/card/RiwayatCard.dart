...
class _ChildCardState extends State<ChildCard> {
  ...
  String _getStatusType() {
    if (widget.anemia &&
        (widget.stunting == "SangatPendek" || widget.stunting == "Pendek")) {
      return 'Keduanya';
    } else if (widget.anemia) {
      return 'Anemia';
    } else if (widget.stunting == "SangatPendek" ||
        widget.stunting == "Pendek") {
      return 'Stunting';
    } else {
      return 'Sehat';
    }
          ...
          if (!filterModel.filter) {
            ...
            Provider.of<RiwayatProvider>(context, listen: false)
                .filterChildrenByMonth(
                    filterModel.month, filterModel.year, filterModel.count);
          }
        },
        child: Container(
          width: width * 0.9,
            ...
            children: [
              ...
              AnimatedCrossFade(
                ...
                firstChild: Column(
                  ...
                  children: [
                    _buildInfoRow(
                        context, Icons.calendar_today, _getFormattedAge()),
                    _buildInfoRow(context, Icons.person, widget.jenisKelamin),
                    _buildInfoRow(
                        context, Icons.monitor_weight, _getMeasurements()),

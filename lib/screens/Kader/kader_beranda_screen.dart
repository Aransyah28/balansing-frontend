  ...
  Widget build(BuildContext context) {
    ...
    return Consumer<DashboardProvider>(
      ...
      if (dashboardProvider.isLoading) {
        ...
        return Center(
          child: Text('Error: ${dashboardProvider.errorMessage}',
        ...
        final monthlyStuntingData =
            Provider.of<DashboardProvider>(context).monthlyStuntingData;
        ...
        final double totalChildren =
            pieChartData.fold(0, (sum, item) => sum + item.value);
                      ...
                      children: [
                        Row(
                          ...
                          children: [
                              ...
                              return GestureDetector(
                                onTap: () {
                                  setState(() {
                                    ...
                                    dashboardProvider
                                        .filterDashboardData(filterModel);
                                  });
                                },
                            ...
                            GestureDetector(
                              onTap: () {
                                String selectedPeriod = periods[_selectedIndex];
                          ...
                          onPressed: () {
                            ...
                            final dashboardProvider =
                                Provider.of<DashboardProvider>(context,
                                    listen: false);
                            final filterModel = Provider.of<FilterModel>(
                                context,
                                listen: false);
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              Row(
                                mainAxisAlignment: MainAxisAlignment.start,
                                children: [
                                  if (stuntingPersen != null) ...[
                                    // Tampilkan hanya jika ada data persentase
                                    // Logika untuk menentukan ikon dan warna berdasarkan nilai persentase
                                    Icon(
                                      stuntingPersen >= 0
                                          ? Icons.trending_up
                                          : Icons.trending_down,
                                      color: stuntingPersen >= 0
                                  ...
                                  Text(
                                    stuntingPersen != null
                                        ? "kasus ${stuntingPersen >= 0 ? 'naik' : 'turun'} dari bulan lalu"
                            ...
                            child: Column(
                              ...
                              children: [
                                ...
                                Row(
                                  ...
                                  children: [
                                    _buildLegendItem("Sangat Pendek",
                                        const Color(0xFFDC2626)),
                                    _buildLegendItem(
                                        "Pendek", const Color(0xFFFACC15)),
                                    _buildLegendItem(
                                        "Normal", const Color(0xFF9FC86A)),
                                    _buildLegendItem(
                                        "Tinggi", const Color(0xFFD0E6B0)),
                                  ],
                                ),
                              ],
                            ),
                              ...
                              children: [
                                ...
                                Row(
                                  ...
                                  children: [
                                    ...
                                    Text(
                                      anemiaPersen != null
                                          ? "kasus ${anemiaPersen >= 0 ? 'naik' : 'turun'} dari bulan lalu"
                                          : "Data bulan lalu tidak tersedia",
                                      style: GoogleFonts.poppins(
                                        fontSize: height * 0.015,
                                        fontWeight: FontWeight.w400,
                        ...
                        Container(
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              SizedBox(
                                height: height *
                                    0.25, // Tinggi yang cukup untuk bar chart
                                child: BarChart(
                                  BarChartData(
                                    alignment: BarChartAlignment.spaceAround,
                                    maxY: findHighestValue(
                                        ageDistributionData), // Sesuaikan dengan nilai maksimum data Anda
                                    barTouchData: BarTouchData(
                                        enabled:
                                            true), // Nonaktifkan interaksi sentuh
                                    titlesData: FlTitlesData(
                                      show: true,
                                      bottomTitles: AxisTitles(
                                        sideTitles: SideTitles(
                                          ...
                                          getTitlesWidget: (value, meta) {
                                            ...
                                            if (value.toInt() >= 0 &&
                                              ...
                                              final data = ageDistributionData[
                                                  value.toInt()];
                                              return SideTitleWidget(
                                                meta: meta,
                                                space: 4.0,
                                      ...
                                      leftTitles: AxisTitles(
                                        sideTitles: SideTitles(
                                          showTitles: false,
                                          interval:
                                              5, // Interval untuk garis horizontal
                                          getTitlesWidget: (value, meta) {
                                            return Text(
                                              value
                                                  .toInt()
                                                  .toString(), // Tampilkan nilai Y sebagai teks
                                              style:
                                                  const TextStyle(fontSize: 10),
                                            );
                                          },
                                          reservedSize:
                                              28, // Ruang untuk label Y
                                        ),
                                      ),
                                      topTitles: const AxisTitles(
                                          sideTitles:
                                    ...
                                    gridData: FlGridData(
                                      show: true,
                                      drawVerticalLine:
                                          false, // Mirip dengan chart pertama
                                      horizontalInterval:
                                          5, // Interval garis horizontal
                                      getDrawingHorizontalLine: (value) {
                                        return const FlLine(
                                          color: Color(
                                              0xFFE2E8F0), // Warna abu-abu
                                          strokeWidth: 1,
                                        );
                                      },
                                    ),
                                      ...
                                      return BarChartGroupData(
                                        ...
                                        barRods: [
                                          BarChartRodData(
                                            ...
                                            color: Color(
                                                0xFFFACC15), // Warna untuk laki-laki
                                            width: width * 0.03,
                                            borderRadius: BorderRadius.circular(
                                                4), // Bar tidak melengkung
                                          ),
                                          BarChartRodData(
                                            toY: data.females.toDouble(),
                                            color: Color(
                                                0xFF93C5FD), // Warna untuk perempuan
                                            width: width * 0.03,
                                            borderRadius:

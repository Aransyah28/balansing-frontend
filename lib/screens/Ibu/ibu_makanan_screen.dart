          ...
          children: [
            ...
            Container(
              ...
              child: Column(
                ...
                crossAxisAlignment: CrossAxisAlignment.start,
                children: [
                  Image.asset("assets/images/Tutorial.jpg",
                      width: double.infinity),
                  SizedBox(
                    height: height * 0.02,
                  ),
                  ...
                  Text(
                    "Panduan untuk menggunakan fitur Cek Variasi Makanan.",
                    style: GoogleFonts.poppins(
                    ...
                    child: ElevatedButton(
                      onPressed: () async {
                        ...
                        await Navigator.push(
                          ...
                          context,
                          MaterialPageRoute(
                            builder: (context) => const MakananTutorialScreen(),
                          ),
                        );
                      },
            ...
            Container(
              ...
              child: Column(
                ...
                crossAxisAlignment: CrossAxisAlignment.start,
                children: [
                  Image.asset("assets/images/Makanan2.jpg",
                      width: double.infinity),
                  SizedBox(
                    height: height * 0.02,
                  ),
                  ...
                  Text(
                    "Cari tahu skor keberagaman pangannya si Kecil.",
                    style: GoogleFonts.poppins(
                        color: const Color(0xFF64748B),
                        fontSize: width * 0.035,
                        fontWeight: FontWeight.w400),
                    ...
                    child: ElevatedButton(
                      onPressed: () async {
                        await Navigator.push(
                          ...
                          context,
                          MaterialPageRoute(
                            builder: (context) => const MakananIbuScreen(),
                          ),
                        );
                      },
                      style: ElevatedButton.styleFrom(

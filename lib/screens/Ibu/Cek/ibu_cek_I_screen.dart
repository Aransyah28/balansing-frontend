...
class _IbuCekIScreenState extends State<IbuCekIScreen> {
    ...
    try {
      ...
      if (data.isEmpty) {
        ...
        setState(() {
          ...
          _isLoading = false;
          _showSnackbar(
              "Tidak ada data anak ditemukan.", Colors.red, Colors.white);
        });
      } else {
      ...
      setState(() {
        _childData =
            null; // Atur data menjadi null atau biarkan data sebelumnya
        _isLoading = false;
        _showSnackbar("Gagal memuat data: Periksa koneksi internet.",
  ...
  Future<void> _submitRecapData(BuildContext context) async {
    ...
    _showSnackbar(
        "Sedang memproses data...", const Color(0xFF64748B), Colors.white);

    try {
      final response = await ibuProvider.postRecapData(dataAnak: dataAnak);

      _showSnackbar(
          "Data berhasil dikirim!", const Color(0xFF9FC86A), Colors.white);
        ...
        await Navigator.push(
          ...
          MaterialPageRoute(
            builder: (context) => IbuCekIIScreen(
                id: response['anakIbu']['kodeRecap'], idAnak: widget.id),
          ),
        );
      ...
      if (mounted) {
        _showSnackbar(
            "Gagal mengirim data: ${e.toString()}", Colors.red, Colors.white);
      }
    } finally {
      _setLoading(false);
    }
  ...
  Widget _buildRadioRow({
    ...
    required bool
        valueForYes, // Nilai boolean untuk opsi 'Ya' (atau 'Merah Segar')
            ...
            SingleChildScrollView(
              child: Container(
                ...
                padding: EdgeInsets.symmetric(
                    horizontal: width * 0.05, vertical: 16.0),
                child: Column(
                  mainAxisAlignment: MainAxisAlignment.start,
                  crossAxisAlignment: CrossAxisAlignment.start,
                  children: [
                    ...
                    Text(
                        "Yuk, lengkapi data kesehatan si kecil agar kami bisa bantu cek apakah ia berisiko stunting atau anemia.",
                        style: GoogleFonts.poppins(
                          color: const Color(0xFF64748B),
                          fontSize: width * 0.03,
                          fontWeight: FontWeight.w400,
                    ...
                    if (_isLoading)
                      ...
                      const Center(
                          child: Text("Tidak ada data anak yang ditemukan.")),
                    SizedBox(height: height * 0.02),
                    Container(
                      width: double.infinity,
                      decoration: BoxDecoration(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          _buildRadioRow(
                            title: "Konjungtiva",
                            question:
                                "Saat kelopak mata bawah anak ditarik perlahan, apakah warnanya merah segar?",
                            valueForYes: false,
                          ...
                          TextButton(
                            ...
                            style: TextButton.styleFrom(
                              ...
                              tapTargetSize: MaterialTapTargetSize
                                  .shrinkWrap, // Area tap lebih kecil
                            ),
                            child: Row(
                              mainAxisSize: MainAxisSize
                                  .min, // Agar Row hanya mengambil ruang yang dibutuhkan
                              children: [
                                Text(
                            ...
                            SingleChildScrollView(
                                ...
                                child: Row(children: [
                                  SizedBox(
                                    height: height * 0.2,
                                    child: Image.asset(
                                        'assets/images/konjungtivaI.png'),
                                  ),
                                  SizedBox(width: width * 0.05),
                                  SizedBox(
                                    height: height * 0.2,
                                    child: Image.asset(
                                        'assets/images/konjungtivaII.jpg'),
                                  ),
                                ])),
                            ...
                            SingleChildScrollView(
                                ...
                                child: Row(children: [
                                  SizedBox(
                                    height: height * 0.2,
                                    child:
                                        Image.asset('assets/images/kukuI.png'),
                                  ),
                                  SizedBox(width: width * 0.05),
                                  SizedBox(
                                    height: height * 0.2,
                                    child: Image.asset(
                                        'assets/images/kukunew.png'),
                                  ),
                                ])),

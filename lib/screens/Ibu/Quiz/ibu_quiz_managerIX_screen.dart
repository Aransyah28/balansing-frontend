...
import 'package:balansing/screens/Ibu/Quiz/ibu_quiz_result_screen.dart';

class IbuQuizManagerIXScreen extends StatefulWidget {
  const IbuQuizManagerIXScreen({super.key});

  @override
  State<IbuQuizManagerIXScreen> createState() => _IbuQuizManagerVIScreen();
}

class _IbuQuizManagerVIScreen extends State<IbuQuizManagerIXScreen> {
